...
public class OperatorTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("num1+num2 = r1 : " + r1);
		System.out.println("num1-num2 = r2 : " + r2);
		System.out.println("num2*num3 = r3 : " + r3);
		System.out.println("num4/num2 = r4 : " + r4);
		System.out.println("num4%num3 : " + r5);
		...
		// 복합대입연산자
		int n1 = 1; int n2 = 2; int n3 = 3; int n4 = 4; int n5 = 5; boolean n6 = true; int n7 =7;
		n1 += 1;
		n2 -= 2;
		n3 *= 3;
		n4 /= 4;
...
//		n7 != 7;
		...
		boolean rs6 = var1 != var2; // var1은 var2 서로 다르다.
		...
		boolean res4 = (var3 > 4) || (var4 > 5); // var3은 4보다 크고 또는 var4sms 5보다 크다.
