...
class Customer{
	...
	public void showInfo() {
		System.out.println("==========================");
		System.out.println("고 객 번 호   : " + id);
		System.out.println("고 객 이 름   : " + name);
...
public class Test07 {
	...
	public static void main(String[] args) {
		...
		System.out.println(kim.name + "님이 지불할 금액 : " + kim.calcPrice(10000));
		System.out.println(lee.name + "님이 지불할 금액 : " + lee.calcPrice(10000));
